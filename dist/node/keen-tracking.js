...
function sendEventData(path, eventData, callback) {
  ...
  var config = _extends({
    ...
    headers: {
      ...
      'ecomsig-sdk': 'javascript-' + _package.version
    }
